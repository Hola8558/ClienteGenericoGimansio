...
@Component({
  ...
  styleUrls: ['./edit-excercise.component.css']
})
export class EditExcerciseComponent {
  ...
  async inicio() {
    ...
    (await this.rutinasService.getOneExcercise( this.data._id )).subscribe(
      ( res : any ) => {
        this.form.get('nombre')?.setValue(res.nombre)
        this.form.get('url')?.setValue(res.url)
        this.form.get('grupoMuscular')?.setValue(res.grupoMuscular)
        this.form.get('description')?.setValue(res.description)
        this.form.get('grupoMuscularText')?.setValue(res.grupoMuscularText)
  ...
  async subir(){
    ...
    (await this.rutinasService.updateExcecise( this.data._id ,ejercicio )).subscribe(
      (res : any) => {
        this.onNoClick( true );
      },
      (err : any) => {
