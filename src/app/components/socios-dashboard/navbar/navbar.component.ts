...
export class NavbarComponent {
  ...
  constructor(private media: MediaMatcher, private router: Router, private loginService : LoginService, private breakpointObserver: BreakpointObserver, private activatedRoute: ActivatedRoute) {
    ...
    if (this.title === 'Rutinas'){
      this.router.navigate(['socios-SportHouse/rutinas']);
      return
    }else {
